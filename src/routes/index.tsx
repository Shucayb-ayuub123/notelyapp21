    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-6 pt-16 pb-24 text-center">
        ...
        <p className="mx-auto mt-5 max-w-xl text-lg text-muted-foreground">
          Write, edit and revisit your thoughts. Every note stays permanently tied to your
          account — nobody else can read it.
        </p>
        ...
        <div className="mx-auto mt-16 grid max-w-2xl gap-4 text-left sm:grid-cols-3">
          {[
            { icon: Lock, title: "Yours only", body: "Row-level security locks notes to your account." },
            { icon: NotebookPen, title: "Fast writing", body: "Create, edit and delete in a single view." },
            { icon: Sparkles, title: "Always saved", body: "Notes persist with your account forever." },
          ].map((f) => (
